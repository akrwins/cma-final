...
// REMOVED body-parser (Express handles this now)

const app = express();

// --- CRITICAL FIX 1: USE RENDER'S PORT ---
const PORT = process.env.PORT || 5000;

app.use(cors());
// --- CRITICAL FIX 2: USE EXPRESS PARSER ---
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial; border: 1px solid #ddd; padding: 20px;">
        ...
        <h3 style="background: #eee; padding: 5px;">Time: ${donationDetails.dropTime}</h3>
      </div>
    `
  };
